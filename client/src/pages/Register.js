...
const Register = () => {
  ...
  const validateForm = (fullname, email, password, confirm_password, usertype, agreeTerms) => {
    const errors = {};
    if (!fullname) {
  ...
  const handelRegForm = async e => {
    ...
    const isValid = validateForm(fullname, email, password, confirm_password, usertype, agreeTerms);
  ...
  if (loading) {
    ...
    return (
      <div className='container register-box mt-3'>
